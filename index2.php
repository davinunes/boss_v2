...
if($dados[login]){
	...
	echo "<a href='speed.php?login=".$dados[login]." '><div class='chip deep-green darken-3'>".$dados[login]." </div> </a>";
}
...
echo "<a id='modalup' class=\"right waves-effect waves-light btn-large modal-trigger\" href=\"#fechar\"><i class='left  material-icons'>edit</i>Comentar</a>&#160;";
...
?>
    ...
    <div class="modal-content">
	  ...
	  <form class="col s12" id="form0s">
					  ...
					  if($adm){
					  echo '<div class="row">
							<label>Selecione o Usuário para alterar a foto:</label>
							<div class="input-field col s12">
					  ...
					  foreach($list as $a){
						  ...
						  echo "<option value='".$a['idUser']." $selecionado' data-icon='".$a[img]."'>".$a[nome]."</option>";
					  }
